...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LD2_Pin|TOF_XSHUT_5_Pin|TOF_XSHUT_0_Pin|TOF_XSHUT_1_Pin 
                          |TOF_XSHUT_2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, TOF_XSHUT_4_Pin|TOF_XSHUT_3_Pin, GPIO_PIN_RESET);
